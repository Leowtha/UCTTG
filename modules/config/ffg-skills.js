export const skills = {
  ...
  "Knowledge: Colonies": { value: "Knowledge: Colonies", label: "SWFFG.SkillsNameKnowledgeColonies", abrev: "SWFFG.SkillsNameKnowledgeColonies" },
  "Knowledge: Earth": { value: "Knowledge: Earth", label: "SWFFG.SkillsNameKnowledgeEarth", abrev: "SWFFG.SkillsNameKnowledgeEarth" },
  ...
  "Knowledge: Extraspatial": { value: "Knowledge: Extraspatial", label: "SWFFG.SkillsNameKnowledgeExtraspatial", abrev: "SWFFG.SkillsNameKnowledgeExtraspatial" },
  ...
  "Pathfinding: Earth": { value: "Pathfinding: Earth", label: "SWFFG.SkillsNamePathfindingEarth", abrev: "SWFFG.SkillsNamePathfindingEarth" },
  "Pathfinding: Space": { value: "Pathfinding: Space", label: "SWFFG.SkillsNamePathfindingSpace", abrev: "SWFFG.SkillsNamePathfindingSpace" },
  "Perception": { value: "Perception", label: "SWFFG.SkillsNamePerception", abrev: "SWFFG.SkillsNamePerception" },
  "Piloting: Earth": { value: "Piloting: Earth", label: "SWFFG.SkillsNamePilotingEarth", abrev: "SWFFG.SkillsNamePilotingEarth" },
...
export const skills_knowledge_stripped = {
  "Knowledge: Colonies": "SWFFG.SkillsNameKnowledgeColonies",
  "Knowledge: Earth": "SWFFG.SkillsNameKnowledgeEarth",
  "Knowledge: Education": "SWFFG.SkillsNameKnowledgeEducationStripped",
  "Knowledge: Extraspatial": "SWFFG.SkillsNameKnowledgeExtraspatial",
