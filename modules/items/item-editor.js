...
export class itemEditor extends FormApplication  {
  ...
  */
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(
      super.defaultOptions,
      {
        ...
        //height: 720,
        width: 520,
        template: "systems/ucttg/templates/items/dialogs/ffg-embedded-itemattachment.html",
        closeOnSubmit: false,
        submitOnClose: true,
        submitOnChange: true,
        resizable: true,
        classes: ["ucttg", "flat_editor"],
  ...
  /** @override */
  get template() {
    const path = "systems/ucttg/templates/items/dialogs";
